...
+ (BRDatePickerView *)datePickerWithDateType:(BRDatePickerMode)dateType
                defaultSelValue:(NSString *)defaultSelValue
                    resultBlock:(BRDateResultBlock)resultBlock {
    return [self datePickerWithDateType:dateType defaultSelValue:defaultSelValue minDate:nil maxDate:nil isAutoSelect:NO themeColor:nil resultBlock:resultBlock cancelBlock:nil];
}
...
+ (BRDatePickerView *)datePickerWithDateType:(BRDatePickerMode)dateType
                defaultSelValue:(NSString *)defaultSelValue
                   ...
                   isAutoSelect:(BOOL)isAutoSelect
                    ...
                    resultBlock:(BRDateResultBlock)resultBlock {
    return [self datePickerWithDateType:dateType defaultSelValue:defaultSelValue minDate:minDate maxDate:maxDate isAutoSelect:isAutoSelect themeColor:themeColor resultBlock:resultBlock cancelBlock:nil];
}
...
+ (BRDatePickerView *)datePickerWithDateType:(BRDatePickerMode)dateType
    ...
    BRDatePickerView *datePickerView = [[BRDatePickerView alloc]initWithDateType:dateType defaultSelValue:defaultSelValue minDate:minDate maxDate:maxDate isAutoSelect:isAutoSelect themeColor:themeColor resultBlock:resultBlock cancelBlock:cancelBlock];
    return datePickerView;
}

#pragma mark - 初始化时间选择器
- (instancetype)initWithDateType:(BRDatePickerMode)dateType
              defaultSelValue:(NSString *)defaultSelValue
                      minDate:(NSDate *)minDate
                      maxDate:(NSDate *)maxDate
                 isAutoSelect:(BOOL)isAutoSelect
...
#pragma mark - 初始化子视图
- (void)initUI {
    self.frame = CGRectMake(0, SCREEN_HEIGHT - kTopViewHeight - kPickerHeight - BR_BOTTOM_MARGIN, SCREEN_WIDTH, kTopViewHeight + kPickerHeight + BR_BOTTOM_MARGIN);
...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        _leftBtn.titleLabel.font = [UIFont fontWithName:@"PingFang-SC-Medium" size: 17];
        [_leftBtn setTitleColor:[UIColor colorWithRed:90/255.0 green:108/255.0 blue:129/255.0 alpha:1.0] forState:UIControlStateNormal];
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        _rightBtn.frame = CGRectMake(self.frame.size.width - 65, 8, 60, 28);
        _rightBtn.autoresizingMask = UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleLeftMargin;
        _rightBtn.titleLabel.font = [UIFont fontWithName:@"PingFang-SC-Bold" size: 17];
        [_rightBtn setTitleColor:[UIColor colorWithRed:61/255.0 green:140/255.0 blue:255/255.0 alpha:1.0] forState:UIControlStateNormal];
...
- (UIDatePicker *)datePicker {
    if (!_datePicker) {
        _datePicker = [[UIDatePicker alloc]initWithFrame:CGRectMake(0, kTopViewHeight + 0.5, self.frame.size.width, kPickerHeight)];
...
- (UIPickerView *)pickerView {
    if (!_pickerView) {
        _pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, kTopViewHeight + 0.5, self.frame.size.width, kPickerHeight)];
